...
<%@ page import = "model.Cart"%>
 <% // get the cart from the session
	...
	String info = aCart.getArrayList();
	%>
...
<table width="1000" border="0" id="spxq">
  ...
  <tr>
    <td colspan="3">Total：
    <label><a href="javascript:;"></a></label></td>
  </tr>
  <tr>
    <td colspan="6"><a href="ordersubmit.jsp"><img src="image/dingdan.gif"align="right" height="40%"
    width="40%"/></a></td>
  </tr>
</table>
